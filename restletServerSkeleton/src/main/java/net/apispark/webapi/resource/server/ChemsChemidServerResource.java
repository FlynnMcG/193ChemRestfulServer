...
import net.apispark.webapi.resource.ChemsChemidResource;
import net.apispark.webapi.utils.QueryParameterUtils;
import net.apispark.webapi.utils.PathVariableUtils;

public class ChemsChemidServerResource extends AbstractServerResource implements ChemsChemidResource {
    ...
    public net.apispark.webapi.representation.Chem store(net.apispark.webapi.representation.Chem bean) throws Exception {
       net.apispark.webapi.representation.Chem result = null;
	    ...
	    String chemidPathVariable = Reference.decode(getAttribute("chemid"));
