...
import net.apispark.webapi.resource.server.ChemsServerResource;
import net.apispark.webapi.resource.server.ChemsChemidServerResource;
...
public class WebApiApplication extends Application {
     ...
     */
    public static final String ROUTE_CHEMS = "/Chems/";

    public static final String ROUTE_CHEMSCHEMID = "/Chems/{chemid}";
    ...
    public Router createApiRouter() {
        ...
        apiRouter.attach(ROUTE_CHEMS.substring(0, ROUTE_CHEMS.length()-1), ChemsServerResource.class);
        apiRouter.attach(ROUTE_CHEMS, ChemsServerResource.class);
        apiRouter.attach(ROUTE_CHEMSCHEMID, ChemsChemidServerResource.class);
