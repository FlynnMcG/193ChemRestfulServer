...
public class SecurityConfig {
    ...
    public SecurityConfig() {
        ...
        globalRequirements.add(net.apispark.webapi.security.authenticators.defined.HTTP_BASICAuthenticator.class);
    }
    ...
    /**
     * Adds configuration for the authentication scheme: All GET methods are public, meaning that *you can read all the data*. Write operations require authentication and therefore are forbidden to the general public..
     *
     * @param userId
     *            The user identifier.
     * @param password
    ...
    public SecurityConfig configureAuthHTTP_BASIC(String userId, String password) {
        configureAuth(new net.apispark.webapi.security.authenticators.defined.HTTP_BASICAuthenticator(userId, password));
        return this;
    }
